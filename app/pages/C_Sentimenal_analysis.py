...
st.write("How to use it? You select a month, for example from 31-08-2022 to 29-09-2022\
...
with c3:
    st.metric(
            ...
            value=str(filtered_tweets[filtered_tweets["sentiment_base"]=="positive"].shape[0]),
        )

with c4:
    st.metric(
            label=f"Number of tweets negatives tweets:",
            value=str(filtered_tweets[filtered_tweets["sentiment_base"]=="negative"].shape[0]),
        )
