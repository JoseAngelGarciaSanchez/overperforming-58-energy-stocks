...
st.write(
    """
    Improving the performance of 58 energy stocks. To do this, we web scraping tweets for the 58 stocks by classifying each of them thanks to a NLP model that we have built. Then, in t+1 we buy or sell the stocks based on the analyzed tweets. This could be completed by news on bloomberg or other media such as bolsamania.
    """
)
